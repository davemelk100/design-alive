    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-8 py-5 flex items-center">
        ...
        <a
          ...
          className="flex-shrink-0 ml-4 text-[13px] font-light uppercase tracking-wider hover:opacity-70 transition-opacity whitespace-nowrap flex items-center gap-2"
          style={{ color: "hsl(var(--muted-foreground))" }}
        >
          Another MELKONIAN INDUSTRIES production
          <svg width="542" height="542" viewBox="0 0 542 542" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" style={{ color: "hsl(var(--muted-foreground))" }}>
