    ...
    <div className="prose prose-gray max-w-none">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4 space-y-2">
          ...
          <li>
            ...
            we collect your email address and the content of your message.
          </li>
        </ul>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4 space-y-2">
          <li>
            ...
            website (e.g., hosting, analytics, payment processing).
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4 space-y-2">
          ...
          <li>
            <strong>Opt-Out:</strong> You can opt out of certain data collection
            practices, such as cookies, by adjusting your browser settings.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          services after such changes constitutes your acceptance of the updated
          policy.
        </p>
      </section>
