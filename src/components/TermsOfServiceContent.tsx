  ...
  return (
    <div className="prose prose-gray max-w-none">
      ...
      <p className="text-gray-700 dark:text-gray-300 mb-8">
        Welcome to davemelk.com. By accessing or using our website and services,
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          our Privacy Policy. If you do not agree to these terms, you may not
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">This website provides access to:</p>
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4 space-y-2">
          <li>Portfolio and professional work samples</li>
          <li>Articles and written content</li>
          <li>Design projects and case studies</li>
          <li>Interactive demonstrations and tools</li>
          <li>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          create an account through Google OAuth authentication. You agree to:
        </p>
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4 space-y-2">
          <li>
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          discretion if you violate these Terms of Service.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          graphics, logos, images, videos, software, and design elements, is the
          property of Dave Melkonian or its content suppliers and is protected
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          publish, license, create derivative works from, or sell any content
          obtained from this website without our prior written consent.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          caused by or in connection with the use of any third-party content,
          goods, or services.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          If you make purchases through our store, you agree to:
        </p>
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4 space-y-2">
          <li>Provide accurate and complete payment information</li>
          <li>
            Pay all charges incurred by you at the prices in effect when such
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          We use Stripe as our payment processor. By making a purchase, you also
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          error-free, or that any defects will be corrected. We make no
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          TO THE FULLEST EXTENT PERMITTED BY LAW, DAVE MELKONIAN SHALL NOT BE
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          You agree to defend, indemnify, and hold harmless Dave Melkonian and
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          Any disputes arising out of or relating to these Terms or our services
          shall be resolved through binding arbitration in accordance with the
          American Arbitration Association's rules, except that either party may
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          the entire agreement between you and Dave Melkonian regarding our
