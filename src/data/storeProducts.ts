...
export const storeProducts: Product[] = [
  ...
  },
  {
    ...
    price: 24.99,
    image: "/img/balm-curb.webp",
    images: ["/img/balm-curb.webp", "/img/balm-hat.webp"],
    description: "BALM - Hat",
    fullDescription:
      "Show off your artistic flair with this unique cap featuring creative designs. Made from high-quality materials with an adjustable strap for the perfect fit.",
    sizes: ["One Size"],
  ...
  },
  {
    ...
    fullDescription:
      "Channel your inner rock star with this classic rock and roll t-shirt. Featuring iconic design elements that celebrate the golden age of rock music, this premium tee is a must-have for music enthusiasts.",
    sizes: ["L", "XL"],
    colors: ["Black", "White"],
  },
  {
