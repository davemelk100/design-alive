    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 p-8 pb-32">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-4 title-font">
            Articles Archive
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <div className="relative flex-1">
              <LazyIcon name="Search" className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" fallback="🔍" />
              <input
                type="text"
                placeholder="Search articles..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-800 dark:border-gray-600 text-foreground"
              />
            </div>
          </div>
            ...
            >
              <div className="grid md:grid-cols-3 gap-8 items-center">
                ...
                <div className="md:col-span-2">
                  <h3 className="mb-3 text-xl font-semibold text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors font-card">
                    {article.title}
                  </h3>

                  <div className="flex items-center gap-4 mb-4 text-sm text-foreground/70">
                    <div className="flex items-center gap-1">
                      <LazyIcon name="Calendar" className="h-4 w-4" fallback="📅" />
