...
export default function PrivacyPolicy() {
  usePageMeta({
    title: "Privacy Policy | Themal",
    description:
      "Themal's privacy policy. Learn what data we collect, how we use it, and your rights. Design preferences are stored locally in your browser.",
  });
