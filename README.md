...
- **AI theme generation** — Describe a theme in natural language and get a full color palette and typography settings generated by Claude, with prompt caching for efficient API usage
