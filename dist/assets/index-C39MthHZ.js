const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/Article-vpRLAOIz.js",
      "assets/vendor-Fh7Ko2ZQ.js",
      "assets/utils-BeI7nAoy.js",
      "assets/ui-DcZvyeQ8.js",
      "assets/Archive-BZ08vcdx.js",
      "assets/DesignArchive-C39vG3G1.js",
      "assets/Admin-B0DUX457.js",
      "assets/adminAuth-J62VGOI8.js",
      "assets/AdminLogin-R_1aeyUh.js",
      "assets/AdminMusic-CVwgyXoQ.js",
      "assets/MusicPlayer-q9L1m0KD.js",
      "assets/WritingGallery-ClqtiLN6.js",
      "assets/DesignSystem-D-ONc5c4.js",
    ])
) => i.map((i) => d[i]);
...
import {
  ...
  L as c,
  R as d,
} from "./vendor-Fh7Ko2ZQ.js";
import { A as h, m, L as g } from "./ui-DcZvyeQ8.js";
import {
  X as p,
  S as u,
  M as f,
...
function W(e, t, i) {
  var a,
    ...
    s = null,
    r = null;
  for (a in (void 0 !== i && (s = "" + i),
  void 0 !== t.key && (s = "" + t.key),
  void 0 !== t.ref && (r = t.ref),
  t))
    M.call(t, a) && !z.hasOwnProperty(a) && (n[a] = t[a]);
  if (e && e.defaultProps)
    for (a in (t = e.defaultProps)) void 0 === n[a] && (n[a] = t[a]);
  return { $$typeof: E, type: e, key: s, ref: r, props: n, _owner: _.current };
}
(D.Fragment = L), (D.jsx = W), (D.jsxs = W), (P.exports = D);
var U = P.exports,
  B = {},
  H = a;
(B.createRoot = H.createRoot), (B.hydrateRoot = H.hydrateRoot);
const O = {},
  R = function (e, t, i) {
  ...
  V = {
    siteInfo: { subtitle: "Dave Melkonian" },
    navigation: {
      social: {
        linkedin: { url: "https://www.linkedin.com/in/davemelk/" },
        dribbble: { url: "https://dribbble.com/davemelk100" },
      },
    },
    work: {
          ...
          U.jsxs("div", {
            ...
            children: [
              ...
              U.jsx("p", {
                ...
                children: "Preparing animations and assets...",
              }),
            ],
          }),
          U.jsx("div", {
            className:
              "w-64 bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-4",
            children: U.jsx("div", {
              className:
                "bg-gradient-to-r from-orange-500 to-teal-500 h-2 rounded-full transition-all duration-300 ease-out",
              style: { width: `${r}%` },
            }),
          }),
          U.jsxs("div", {
            className: "text-sm text-gray-500 dark:text-gray-400",
            children: [t, " / ", n, " assets loaded"],
          }),
        ],
      }),
    });
  };
function F({ title: e, content: t, image: a, onClose: n }) {
  i.useEffect(() => {
    const e = (e) => {
      "Escape" === e.key && n();
    };
  ...
  return U.jsx(h, {
    children: U.jsx(m.div, {
      ...
      children: U.jsx(m.div, {
        ...
        className:
          "relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-white dark:bg-gray-900 rounded-lg shadow-xl",
        ...
        children: U.jsxs("div", {
          ...
          children: [
            U.jsxs("div", {
              ...
              children: [
                U.jsx("h2", {
                  className: "text-[20px] font-semibold dark:text-white",
                  children: e,
                }),
                U.jsx("button", {
                  onClick: n,
                  ...
                  children: U.jsx(p, { className: "h-4 w-4 sm:h-5 sm:w-5" }),
                }),
              ],
            }),
            a &&
              U.jsx("div", {
                className:
                  "float-right ml-8 mb-4 w-1/2 aspect-video overflow-hidden rounded-lg",
                children: U.jsx("img", {
                  src: a,
                  alt: e,
                  ...
                  .map((e, t) =>
                    e.startsWith("## ")
                      ? U.jsx(
                          ...
                          {
                            className:
                              "text-2xl font-bold mb-4 mt-6 dark:text-white",
                            children: e.replace("## ", ""),
                          },
                          t
                        )
                      : e.includes(
                          "I mean, make sure my tombstone uses Helvetica"
                        )
                      ? U.jsxs(U.Fragment, {
                          children: [
                            U.jsxs(
                              ...
                              {
                                className:
                                  "float-right w-1/2 ml-8 my-4 p-8 border-l-4 border-primary bg-gray-50 dark:bg-gray-800 text-2xl relative font-serif",
                                children: [
                                  U.jsx("span", {
                                    className:
                                      "absolute -top-4 -left-4 text-6xl text-primary/20",
                                    children: '"',
                                  }),
                                  e,
                                  U.jsx("span", {
                                    className:
                                      "absolute -bottom-8 -right-4 text-6xl text-primary/20",
                                    children: '"',
                                  }),
                                ],
                              },
                      ...
                      : e.includes("if your product has 10,000 users")
                      ? U.jsxs(U.Fragment, {
                          children: [
                            U.jsx(
                              "p",
                      ...
                      : U.jsx(
                          "p",
                          { className: "mb-4 dark:text-gray-200", children: e },
                          t
                        )
                  )),
            }),
...
const $ = i.createContext({ isDarkMode: !1, toggleDarkMode: () => {} }),
  J = ({ children: e }) => {
  ...
  X = () => {
    const { isDarkMode: e, toggleDarkMode: t } = i.useContext($);
    return U.jsx("button", {
      onClick: t,
      className: "hover:opacity-70 transition-opacity text-black relative z-10",
      "aria-label": e ? "Switch to light mode" : "Switch to dark mode",
      children: e
        ? U.jsx(u, { className: "h-5 w-5" })
        : U.jsx(f, { className: "h-5 w-5" }),
    });
  };
function G(e) {
  return e
...
const Y = (e, t = "mainPage") =>
    e.filter((e) =>
      ((e, t = "mainPage") => {
        var i;
        try {
          const a = localStorage.getItem("contentVisibility");
          if (a) {
            const n = null == (i = JSON.parse(a).articles) ? void 0 : i[e];
            return !n || "object" != typeof n || !1 !== n[t];
          }
          return !0;
        } catch (a) {
          return !0;
  ...
  K = (e) =>
    ...
    (() => {
      try {
        const e = localStorage.getItem("contentVisibility");
        return e ? JSON.parse(e) : { designWork: {} };
      } catch (e) {
        return { designWork: {} };
      }
    })().designWork[e],
  Q = (e) => e.filter((e) => K(e.title)),
  Z = ({
    src: e,
    className: t,
    style: a,
    ...
    return (
      i.useEffect(() => {
        const e = new IntersectionObserver(
          ([t]) => {
            t.isIntersecting && (c(!0), e.disconnect());
          },
        ...
        children: [
          l &&
            U.jsxs("video", {
              ...
              playsInline: o,
              children: [
                U.jsx("source", { src: e, type: "video/mp4" }),
  ...
  ee = (e) =>
    ...
    (() => {
      try {
        const e = localStorage.getItem("contentVisibility");
        return e ? JSON.parse(e) : { labProjects: {} };
      } catch (e) {
        return { labProjects: {} };
      }
    })().labProjects[e],
...
const se = new (class {
    constructor() {
      t(this, "primaryBackend"),
        t(this, "fallbackBackend"),
        t(this, "isAvailable", !0),
        this.testStorageAvailability("localStorage")
          ? ((this.primaryBackend = new ie()),
            (this.fallbackBackend = new ae()))
          : this.testStorageAvailability("sessionStorage")
          ? ((this.primaryBackend = new ae()),
            (this.fallbackBackend = new ne()))
          : ((this.primaryBackend = new ne()),
            (this.fallbackBackend = new ne()),
            (this.isAvailable = !1));
    }
    testStorageAvailability(e) {
      try {
        const t = window[e],
          i = "__storage_test__";
        return t.setItem(i, "test"), t.removeItem(i), !0;
      } catch (t) {
        return !1;
      }
    }
    get(e, t) {
      try {
        const i = this.primaryBackend.get(e);
        if (null === i) return void 0 !== t ? t : null;
        return JSON.parse(i);
      } catch (i) {
        try {
          const i = this.fallbackBackend.get(e);
          if (null === i) return void 0 !== t ? t : null;
          return JSON.parse(i);
        } catch (a) {
    ...
    set(e, t) {
      try {
        ...
        this.primaryBackend.set(e, i), this.fallbackBackend.set(e, i);
      } catch (i) {
        throw i;
      }
    }
    remove(e) {
      this.primaryBackend.remove(e), this.fallbackBackend.remove(e);
    }
    clear() {
      this.primaryBackend.clear(), this.fallbackBackend.clear();
    }
    ...
    exportData() {
      const e = {};
      try {
        if (this.primaryBackend instanceof ie)
  ...
  re = {
    get: (e, t) => se.get(e, t),
    set: (e, t) => se.set(e, t),
    remove: (e) => se.remove(e),
    clear: () => se.clear(),
    isAvailable: () => se.getStorageAvailability(),
    export: () => se.exportData(),
    import: (e) => se.importData(e),
  },
  oe = "writingGalleryPieces",
  le = "contentVisibility",
  ce = "adminSession",
  de = {
    getPieces: () => re.get(oe, []),
    setPieces: (e) => re.set(oe, e),
    clearPieces: () => re.remove(oe),
  },
  he = {
    getSettings: () => re.get(le, {}),
    setSettings: (e) => re.set(le, e),
    clearSettings: () => re.remove(le),
  },
  me = {
    getSession: () => re.get(ce, null),
    setSession: (e) => re.set(ce, e),
    clearSession: () => re.remove(ce),
  },
  ge = () => {
    const e = { success: !0, migratedKeys: [], errors: [] };
    try {
      [
        ...
        try {
          ...
          if (i) {
            ...
            let n = t;
            if ("writingGalleryPieces" === t) n = oe;
            else if ("contentVisibility" === t) n = le;
            else if ("adminAuthenticated" === t || "adminAuthTime" === t) {
              if ("adminAuthenticated" === t) {
                const t = localStorage.getItem("adminAuthTime");
                if (t) {
                  re.set(ce, { isAuthenticated: "true" === i, authTime: t }),
                    e.migratedKeys.push("adminSession");
                }
              }
              return;
            }
            re.set(n, a), e.migratedKeys.push(n), localStorage.removeItem(t);
          }
        } catch (i) {
          e.errors.push(`Failed to migrate ${t}: ${i}`), (e.success = !1);
        }
      });
      const i = localStorage.getItem("adminAuthenticated"),
        a = localStorage.getItem("adminAuthTime");
      if (i && a && !e.migratedKeys.includes("adminSession"))
        try {
          re.set(ce, { isAuthenticated: "true" === i, authTime: a }),
            e.migratedKeys.push("adminSession"),
            localStorage.removeItem("adminAuthenticated"),
            localStorage.removeItem("adminAuthTime");
        } catch (t) {
          e.errors.push(`Failed to migrate admin session: ${t}`),
            (e.success = !1);
        }
    } catch (t) {
      e.errors.push(`Migration failed: ${t}`), (e.success = !1);
    }
    return e;
  },
  pe = () => ge();
"undefined" != typeof window &&
  [
    ...
    "adminAuthenticated",
    "adminAuthTime",
  ].some((e) => null !== localStorage.getItem(e)) &&
  ge();
const ue = i.lazy(() =>
    R(() => import("./Article-vpRLAOIz.js"), __vite__mapDeps([0, 1, 2, 3]))
  ),
  fe = i.lazy(() =>
    R(() => import("./Archive-BZ08vcdx.js"), __vite__mapDeps([4, 1, 2, 3]))
  ),
  ye = i.lazy(() =>
    R(
      () => import("./DesignArchive-C39vG3G1.js"),
      __vite__mapDeps([5, 1, 2, 3])
    )
  ),
  be = i.lazy(() =>
    R(() => import("./Admin-B0DUX457.js"), __vite__mapDeps([6, 1, 7, 2, 3]))
  ),
  ve = i.lazy(() =>
    R(() => import("./AdminLogin-R_1aeyUh.js"), __vite__mapDeps([8, 1, 2, 3]))
  ),
  xe = i.lazy(() =>
    R(
      () => import("./AdminMusic-CVwgyXoQ.js"),
      __vite__mapDeps([9, 1, 7, 3, 2])
    )
  ),
  we = i.lazy(() =>
    R(() => import("./MusicPlayer-q9L1m0KD.js"), __vite__mapDeps([10, 1, 3, 2]))
  ),
  ke = i.lazy(() =>
    R(
      () => import("./WritingGallery-ClqtiLN6.js"),
      __vite__mapDeps([11, 1, 3, 2])
    )
  ),
  je = i.lazy(() =>
    R(
      () => import("./DesignSystem-D-ONc5c4.js"),
  ...
  Ne = ({
    ...
    U.jsxs("div", {
      ...
      children: [
        U.jsxs("div", {
          ...
          children: [
            U.jsx("div", {
              ...
              children: U.jsx("h2", {
                className:
                  "text-[clamp(1.25rem,3vw,2.5rem)] font-bold title-font leading-tight",
              ...
              children: [
                a &&
                  U.jsx(c, {
                    to: "/archive",
                    className:
                      "text-nav text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 underline",
                ...
                n &&
                  U.jsx("button", {
                    ...
                    className:
                      "bg-black text-white dark:bg-white/10 dark:text-white p-2 rounded-full shadow-lg hover:opacity-80 transition-opacity",
        ...
        t &&
          U.jsx("p", {
            className: "text-base text-muted-foreground mb-8 sm:mb-10",
            children: t,
          }),
      ],
    });
function Ie() {
  ...
  return d
    ? U.jsx(q, { onComplete: () => u(!1) })
    : U.jsxs("div", {
        className:
          "min-h-screen bg-white text-gray-900 transition-colors duration-300 dark:bg-gray-900 dark:text-gray-100",
        children: [
          U.jsx(i.Suspense, {
            fallback: U.jsx("div", {
              className:
              ...
              children: U.jsxs("div", {
                ...
                children: [
                  U.jsx("div", {
                    className:
                      "animate-spin rounded-full h-12 w-12 border-b-2 border-gray-900 mx-auto mb-4",
                  }),
                  U.jsx("p", {
            ...
            children: U.jsxs(o, {
              children: [
                U.jsx(l, {
                  ...
                  element: U.jsxs(U.Fragment, {
                    children: [
                      U.jsx("section", {
                        className:
                          "relative flex flex-col justify-center min-h-[120px] sm:min-h-[160px]",
                        children: U.jsxs("div", {
                          className:
                            "container mx-auto px-4 sm:px-8 pt-8 sm:pt-4 flex flex-col gap-y-2 sm:gap-y-4",
                          children: [
                            U.jsxs("div", {
                              className:
                                "flex flex-row items-center gap-4 relative z-10 mt-5",
                              children: [
                                U.jsxs("div", {
                                  className:
                                    "flex xl:hidden items-center justify-start w-full transition-opacity duration-300 " +
                                    (f ? "opacity-0" : "opacity-100"),
                                  children: [
                                    U.jsx("h1", {
                                      className:
                                        "text-[clamp(1.75rem,5vw,3.5rem)] font-bold mb-1 title-font leading-none relative z-10",
                                      style: { letterSpacing: "-0.06em" },
                                      children: V.siteInfo.subtitle,
                                    }),
                                    U.jsxs("div", {
                                      className: "flex items-center gap-2 ml-4",
                                      children: [
                                        U.jsx("a", {
                                          href: V.navigation.social.linkedin
                                            .url,
                                          target: "_blank",
                                          rel: "noopener noreferrer",
                                          className:
                                            "bg-white/80 hover:bg-white backdrop-blur-sm rounded-full p-2 shadow-md hover:scale-110 transition-all duration-200 w-10 h-10 flex items-center justify-center",
                                          "aria-label": "LinkedIn",
                                          children: U.jsx(g, {
                                        ...
                                        U.jsx("a", {
                                          href: V.navigation.social.dribbble
                                            .url,
                                          target: "_blank",
                                          rel: "noopener noreferrer",
                                          className:
                            ...
                            U.jsx("div", {
                              className:
                                "hidden md:flex md:flex-col lg:flex-row md:items-stretch lg:items-center gap-4 w-full",
                              children: U.jsxs("div", {
                                className:
                                  "hidden md:flex w-full justify-start lg:justify-start rounded-lg pl-0 pr-3 sm:pr-4 py-2 items-center gap-4 sm:gap-6",
                                children: [
                                  U.jsx("button", {
                                    onClick: () => C("current-projects"),
                                    className:
                                      "text-black hover:text-gray-600 dark:text-white dark:hover:text-gray-200 transition-colors text-sm font-bold uppercase",
                                    style: {
                                      fontFamily:
                                  ...
                                  U.jsx(c, {
                                    to: "/design-system",
                                    className:
                                      "text-black hover:text-gray-600 dark:text-white dark:hover:text-gray-200 transition-colors text-sm font-bold uppercase whitespace-nowrap",
                                    style: {
                                      fontFamily:
                                        "Helvetica, Arial, sans-serif",
                                    },
                      ...
                      f &&
                        U.jsx(h, {
                          children: U.jsx(m.div, {
                            ...
                            exit: { opacity: 0 },
                            className:
                              "fixed top-0 left-0 right-0 bottom-0 bg-black/50 z-[9999] xl:hidden",
                            onClick: () => T(!1),
                            children: U.jsxs(m.div, {
                              ...
                              className:
                                "absolute bottom-16 left-0 right-0 bg-white/95 backdrop-blur-sm border-t border-gray-200 p-3 rounded-t-3xl max-h-[70vh] overflow-y-auto",
                              onClick: (e) => e.stopPropagation(),
                              children: [
                                U.jsxs("div", {
                                  className:
                                  ...
                                  children: [
                                    ...
                                    U.jsx("button", {
                                      onClick: () => T(!1),
                                      className:
                                        "bg-gray-100 hover:bg-gray-200 rounded-full p-2 transition-colors",
                                ...
                                U.jsxs("div", {
                                  ...
                                  children: [
                                    U.jsxs("button", {
                                      onClick: () => {
                                        C("current-projects"), T(!1);
                                      },
                                      className:
                                        "flex flex-col items-center gap-2 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors",
                                      children: [
                                        U.jsx("div", {
                                          className:
                                    ...
                                    U.jsxs("button", {
                                      ...
                                      children: [
                                        U.jsx("div", {
                                          className:
                                            "w-8 h-8 bg-teal-500 rounded-full flex items-center justify-center",
                                          children: U.jsx(v, {
                                            className: "h-4 w-4 text-white",
                                          }),
                                        }),
                                    ...
                                    U.jsxs("button", {
                                      ...
                                      children: [
                                        U.jsx("div", {
                                          className:
                                            "w-8 h-8 bg-pink-500 rounded-full flex items-center justify-center",
                                          children: U.jsx(j, {
                                            className: "h-4 w-4 text-white",
                                          }),
                                        }),
                      ...
                      te("lab") &&
                        U.jsx("section", {
                          ...
                          children: U.jsxs("div", {
                            ...
                            children: [
                              U.jsx(Ne, {
                                title: V.currentProjects.title,
                                subtitle: V.currentProjects.subtitle,
                                className: "mb-8",
                                showUpArrow: !1,
                              }),
                              U.jsx("div", {
                                ...
                                children: ((E = V.currentProjects.projects),
                                E.filter((e) => ee(e.title))).map((e, t) =>
                                  U.jsxs(
                                    m.div,
                                    {
                                      initial: { opacity: 0, y: 20 },
                                      ...
                                      className:
                                        "group relative overflow-visible rounded-lg bg-gray-100/80 shadow-md aspect-[1/1]",
                                      children: [
                                        U.jsx("div", {
                                          className:
                                          ...
                                          children: U.jsx("a", {
                                            ...
                                            rel: "noopener noreferrer",
                                            className:
                                              "bg-white/80 hover:bg-white backdrop-blur-sm rounded-full p-2 shadow-md hover:scale-110 transition-all duration-200 w-10 h-10 flex items-center justify-center relative z-20",
                                            children: U.jsx(I, {
                                              className:
                                        ...
                                        U.jsxs("div", {
                                          className:
                                            "absolute inset-0 p-3 flex flex-col gap-2 z-10",
                                          children: [
                                            U.jsxs("div", {
                                              className:
                                              ...
                                              children: [
                                                U.jsx("h3", {
                                                  className:
                                                    "text-[20px] font-semibold mb-1 dark:text-black title-font",
                                                  style: {
                                                        ...
                                                        U.jsx(
                                                          "span",
                                                          {
                                                            style: {
                                                              ...
                                                              borderRadius:
                                                                "50%",
                                                              background: `radial-gradient(circle at 70% 70%, ${e} 0%, ${e} 60%, ${e}dd 100%)`,
                                                              boxShadow:
                                            ...
                                            U.jsx("div", {
                                              ...
                                              children: U.jsx("p", {
                                                className:
                                                  "text-sm text-gray-600 dark:text-gray-600 mb-2 flex-1",
                      ...
                      U.jsx("section", {
                        ...
                        children: U.jsxs("div", {
                          ...
                          children: [
                            U.jsx(Ne, {
                              title: V.stories.title,
                              subtitle: V.stories.subtitle,
                              className: "mb-8",
                            }),
                            U.jsx("div", {
                              className:
                                "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
                              children: V.stories.items.map((e) =>
                                U.jsxs(
                                  m.div,
                                  {
                                    initial: { opacity: 0, y: 20 },
                                    ...
                                    className:
                                      "group relative overflow-hidden rounded-lg bg-gray-100/80 flex flex-col shadow-md",
                                    children: [
                                      U.jsx("div", {
                                        ...
                                        children: e.hasModal
                                          ...
                                          : U.jsx("div", {
                                              className:
                                                "bg-white/80 backdrop-blur-sm rounded-full p-2 shadow-md w-10 h-10 flex items-center justify-center",
                                              children: U.jsx(A, {
                                                className:
                                                  "h-5 w-5 text-gray-600",
                                              }),
                                        ...
                                        children: [
                                          U.jsxs("div", {
                                            ...
                                            children: [
                                              ...
                                              e.subtitle &&
                                                U.jsx("p", {
                                                  className:
                                                    "text-sm text-gray-600 dark:text-gray-600 mb-2",
                                                  children: e.subtitle,
                                                }),
                                            ],
                                          }),
                                          U.jsx("div", {
                                            ...
                                            children:
                                              ...
                                              U.jsx("p", {
                                                className:
                                                  "text-black mb-2 dark:text-black text-card-body flex-1",
                                                children: e.description,
                                              }),
                                          }),
                                        ],
                                      ...
                                      U.jsx("div", {
                                        className:
                                          "relative aspect-[3/2] overflow-visible -mx-3 -mb-3",
                                        children: e.image
                                          ? U.jsx("img", {
                                          ...
                                          : U.jsx("div", {
                                              className:
                                                "absolute inset-0 h-full w-full bg-gray-200/50 flex items-center justify-center",
                                              children: U.jsx("div", {
                                                className:
                          ...
                          children: U.jsxs("div", {
                            ...
                            children: [
                              ...
                              U.jsx("div", {
                                className:
                                  "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
                                children: Y(V.articles.items)
                                  .filter(
                                    (e) =>
                                      "API Tokens: The Digital Arcade" !==
                                        e.title &&
                                      "Commit Message Fatigue" !== e.title &&
                                      "The 5 Design Anti-Patterns" !==
                                        e.title &&
                          ...
                          children: U.jsxs("div", {
                            ...
                            children: [
                              ...
                              U.jsx("div", {
                                className:
                                  "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6",
                                children: Q(V.work.projects)
                                  .filter(
                                    (e) => "3D Conversion UX Plan" !== e.title
                                  )
                                  .map((e, t) => {
                                    const i = U.jsx("div", {
                      ...
                      U.jsx("section", {
                        ...
                        children: U.jsxs("div", {
                          ...
                          children: [
                            U.jsx(Ne, {
                              title: V.career.title,
                              subtitle: V.career.subtitle,
                              className: "mb-8 sm:mb-16",
                            }),
                            U.jsx("div", {
                              className: "space-y-8",
                              children: V.career.positions.map((e) =>
                                U.jsxs(
                                  "div",
                                  {
                                    className: "",
                                    children: [
                                      U.jsx("h3", {
                                        className:
                                          "text-lg font-semibold mb-1 dark:text-black title-font",
                                        style: { letterSpacing: "-0.01em" },
                                        children: e.title,
                                      }),
                                      U.jsx("p", {
                                        className:
                                          "text-sm text-gray-600 dark:text-gray-600 mb-1 font-medium",
                                        children: e.company,
                                      }),
                                      U.jsx("p", {
                                        className:
                                          "text-xs text-gray-500 dark:text-gray-500 mb-2",
                                        children: e.period,
                                      }),
                                      U.jsx("p", {
                                        className:
                                          "text-sm text-gray-700 dark:text-gray-700 leading-relaxed",
                                        children: e.description,
                                      }),
                                    ],
                                  },
                            ...
                            U.jsxs("div", {
                              ...
                              children: [
                                U.jsxs(m.div, {
                                  ...
                                  className:
                                    "group relative overflow-visible rounded-lg bg-gray-100/80 shadow-md aspect-[3/4]",
                                  children: [
                                    U.jsxs("div", {
                                      className:
                                        "absolute inset-0 p-3 flex flex-col gap-2 z-10",
                                      children: [
                                        U.jsx("div", {
                                          ...
                                          children: U.jsx("h3", {
                                            className:
                                              "text-[20px] font-semibold mb-0 dark:text-black title-font",
                                            style: { letterSpacing: "-0.01em" },
                                            children: "Violet",
                                          }),
                                        }),
                                        U.jsx("div", {
                                          ...
                                          children: U.jsx("p", {
                                            className:
                                              "text-base text-gray-600 dark:text-gray-600 mb-1 flex-1",
                                            children:
                                              "My amazing daughter with another line drive for a base hit",
                                          }),
                                        }),
                                      ],
                                    }),
                                      ...
                                      children: [
                                        ...
                                        U.jsx("div", {
                                          ...
                                          children: U.jsx("p", {
                                            className:
                                              "text-base text-gray-600 dark:text-gray-600 mb-1 flex-1",
                                            children: "The game I love to hate",
                                          }),
                                        }),
                                      ],
                                    }),
                ...
                U.jsx(l, { path: "/article/:slug", element: U.jsx(ue, {}) }),
                U.jsx(l, { path: "/archive", element: U.jsx(fe, {}) }),
                U.jsx(l, { path: "/design-archive", element: U.jsx(ye, {}) }),
                U.jsx(l, { path: "/admin-login", element: U.jsx(ve, {}) }),
                U.jsx(l, { path: "/admin", element: U.jsx(be, {}) }),
                U.jsx(l, { path: "/admin-music", element: U.jsx(xe, {}) }),
                U.jsx(l, { path: "/music-player", element: U.jsx(we, {}) }),
                U.jsx(l, { path: "/writing-gallery", element: U.jsx(ke, {}) }),
                U.jsx(l, { path: "/design-system", element: U.jsx(je, {}) }),
              ],
            }),
          }),
          U.jsx("div", {
            className:
              "fixed bottom-0 left-0 right-0 bg-gray-50/95 backdrop-blur-sm border-t border-gray-200 shadow-lg z-[9999] xl:hidden",
            children: U.jsx("div", {
              className: "flex items-center justify-center px-4 py-3",
              children: U.jsx("button", {
                onClick: () => T(!f),
                className:
                  "backdrop-blur-sm rounded-full p-2 shadow-md hover:scale-110 transition-all duration-200 w-10 h-10 flex items-center justify-center " +
                  (f
                    ? "bg-orange-500 text-white"
                    : "bg-white/80 hover:bg-white text-black"),
                "aria-label": "Mobile menu",
                children: U.jsx(S, { className: "h-5 w-5" }),
              }),
            }),
          }),
          e &&
          ...
          U.jsx(c, {
            to: "/admin-login",
            className:
              "fixed top-0 left-0 w-8 h-8 bg-white opacity-0 hover:opacity-20 transition-opacity duration-300 z-[9999] cursor-pointer",
            style: {
              boxShadow: "none",
              border: "none",
              outline: "none",
...
function Ae() {
  return U.jsx(n, { children: U.jsx(J, { children: U.jsx(Ie, {}) }) });
}
"serviceWorker" in navigator &&
  ...
  B.createRoot(document.getElementById("root")).render(
    U.jsx(d.StrictMode, { children: U.jsx(Ae, {}) })
  );
export {
  Z as L,
  re as a,
